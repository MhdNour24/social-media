...
const registerSchema = yup.object().shape({
  ...
  lastName: yup.string().required("the last name isrequired"),
  email: yup.string().email("invalid email").required("the email is required"),
  password: yup.string().required("the passwrod is required"),
  location: yup.string().required("the location is required"),
  occupation: yup.string().required("the occupation is required"),
  picture: yup.string().required("the picture is required"),
});
